...
def generate_img(func, img_name):
    img = deal('meir-rotate.jpg')
    i = func(img)
    i.save("target-file/rotate/" + img_name)


def main():
    generate_img(flip, "flip.png")
    generate_img(flop, "flop.png")
    generate_img(duijiao, "duijiao.png")

    generate_img(joint, "joint.png")

    img = deal('meir-rotate.jpg')
    i = crop(img, (20, 20, 50, 60))
    i.save('target-file/rotate/crop.png')

    img = deal('meir-rotate.jpg')
    i = will(img, 0.5)
    i.save('target-file/rotate/will.png')
